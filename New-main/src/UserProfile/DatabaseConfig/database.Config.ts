	...
	TypeOrmModule.forRoot({
      ...
      //url: process.env.DATABASE_URL,
       ...
       // entities: [User],
        ...
        synchronize: true,
	}),TypeOrmModule.forFeature([User,ProductEntity,tblItem,tblMechanic,SlideShowEntity])
	],
  providers: [AdminService,ProductService,AuthGuard,MechanicService],
  controllers: [AdminController,ProductController,MechanicController],
})
